...
def scrape_soup(url):
    ...
    # Take the text returned by the scrape (aka the HTML content but as plaintext)
    # Pass the plaintext through the BeautifulSoup HTML parser to be returned as HTML
...
def get_thumbnail(url):
    ...
    # os.path.splitext splits the file name of the thumbnail from its extension and puts them into an array
        ...
        if img_scrape.status_code == 200:
            ...
            if img_scrape.content:
                ...
                with open(filename, "wb") as file:
                    ...
                    print(f"Image written as {filename}!") # Print a success message
